...
public enum Cadreur {
	...
	DUGUE       ("M2T", false, ModeleM2T_mencoder_desplit.class,   "merging_M2T_05_SD_prog_rico.py", 	  1200),
	...
	PARADIS_chunk     ("M2T", true,  ModeleM2T_mencoder_desplit.class, "merging_M2T_05_SD_deint_amouroux.py", 1200),
	PARADIS_full      ("M2T", true,  ModeleM2T_mencoder_nodesplit.class, "merging_M2T_05_SD_NO_DESPLIT_deint.py",	  1200),
