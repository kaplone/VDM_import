...
public enum Cadreur {
	...
	BATMAN    ("MXF", true,  ModeleMXF_P2.class, "merging_MXF_08_SD.py"),
	...
	RICO      ("M2T", true,  ModeleM2T_mencoder_desplit.class, "merging_M2T_05_SD_prog_rico.py"),
	...
	VARLET    ("MXF", true,  ModeleMXF_P2.class, "merging_MXF_08_SD.py"),
